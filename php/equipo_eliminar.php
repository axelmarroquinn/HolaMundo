<?php
    ...
    $check_producto=$check_producto->query("SELECT * FROM tbl_inv_equipos WHERE ID_PROD='$product_id_del'");
    ...
    if($check_producto->rowCount()==1){
    	...
    	$eliminar_producto=$eliminar_producto->prepare("DELETE FROM tbl_inv_equipos WHERE id_prod=:id");
